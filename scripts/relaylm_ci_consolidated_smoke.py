...
GROUPS = {
    "relaymem": {
        ...
        "scheduler_worker": ["relaylm/relaymem_slp_primary_worker*", "relaylm/_relaymem_slp_primary_worker*", "relaylm/relaymem_slp_protected_source_store.py", "relaylm/_relaymem_slp_protected_source_*", "relaylm/relaymem_slp_one_queued_job_runner.py", "relaylm/relaymem_slp_scheduler_*", "relaylm/local_worker*", "relaylm/relaymem_held_governance_*", "scripts/relaylm_phase6c1_*", "scripts/_relaylm_phase6c1_*", "scripts/relaylm_phase6c2_*", "scripts/relaylm_o[01]*", "scripts/_relaylm_o[01]*", "scripts/relaylm_i7ab_*", "tests/test_relaymem_held_governance_preflight.py", "docs/architecture/o[01]*", "docs/architecture/phase6c*", "docs/architecture/phase_i7ab_*", "docs/evidence/implementation/o1d2_completion_report.md"],
        "recall_correction_forget_pin": ["relaylm/relaymem_primary_recall.py", "relaylm/relaymem_primary_current_state.py", "relaylm/_relaymem_primary_current_state_impl.py", "relaylm/relaymem_primary_mutation_coordinator.py", "relaylm/relaymem_primary_forget*", "relaylm/_relaymem_primary_forget*", "relaylm/relaymem_primary_correction.py", "relaylm/relaymem_primary_pin.py", "relaylm/relaymem_primary_lifecycle_page.py", "relaylm/_relaymem_primary_lifecycle_page_writer.py", "relaylm/relaymem_primary_retrieval_eligibility.py", "scripts/relaylm_phase_i1_*", "scripts/relaylm_phase_i3_*", "scripts/relaylm_phase_i4*", "scripts/_relaylm_phase_i4*", "scripts/relaylm_phase_i5a_*", "docs/architecture/phase_i[1-5]*", "docs/mvp/wave[3-4]/*", "docs/evidence/implementation/i4e_completion_report.md", "docs/evidence/implementation/i5a_completion_report.md"],
