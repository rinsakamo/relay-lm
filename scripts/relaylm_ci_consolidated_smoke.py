...
GROUPS = {
    "relaymem": {
        ...
        "recall_correction_forget_pin": ["relaylm/relaymem_primary_recall.py", "relaylm/relaymem_primary_current_state.py", "relaylm/_relaymem_primary_current_state_impl.py", "relaylm/relaymem_primary_mutation_coordinator.py", "relaylm/relaymem_primary_forget*", "relaylm/_relaymem_primary_forget*", "relaylm/relaymem_primary_correction.py", "relaylm/relaymem_primary_pin.py", "relaylm/relaymem_primary_lifecycle_page.py", "relaylm/_relaymem_primary_lifecycle_page_writer.py", "relaylm/relaymem_primary_retrieval_eligibility.py", "scripts/relaylm_phase_i1_*", "scripts/relaylm_phase_i3_*", "scripts/relaylm_phase_i4*", "scripts/_relaylm_phase_i4*", "scripts/relaylm_phase_i5a_*", "docs/architecture/phase_i[1-5]*", "docs/mvp/wave4/*", "docs/evidence/implementation/i4d_completion_report.md", "docs/evidence/implementation/i4e_completion_report.md", "docs/evidence/implementation/i5a_completion_report.md"],
