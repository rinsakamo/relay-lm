...
GROUPS = {
    "relaymem": {
        ...
        "durable_finalization": ["relaylm/*durable_finalization*", "relaylm/relaymem_slp_durable_runtime_enqueue.py", "scripts/relaylm_i1g*", "scripts/_relaylm_i1ge_*", "docs/architecture/i1g_*", "docs/evidence/implementation/i1ge_completion_report.md"],
        "scheduler_worker": ["relaylm/relaymem_slp_primary_worker*", "relaylm/_relaymem_slp_primary_worker*", "relaylm/relaymem_slp_protected_source_store.py", "relaylm/_relaymem_slp_protected_source_*", "relaylm/relaymem_slp_one_queued_job_runner.py", "relaylm/relaymem_slp_scheduler_*", "relaylm/local_worker*", "relaylm/relaymem_held_governance_*", "scripts/relaylm_phase6c1_*", "scripts/_relaylm_phase6c1_*", "scripts/relaylm_phase6c2_*", "scripts/relaylm_o[01]*", "scripts/_relaylm_o[01]*", "scripts/relaylm_i7ab_*", "tests/test_relaymem_held_governance_preflight.py", "docs/architecture/o[01]*", "docs/architecture/phase6c*", "docs/architecture/phase_i7ab_*", "docs/evidence/implementation/o1d2_completion_report.md", "docs/evidence/implementation/o1d1_completion_report.md"],
        "recall_correction_forget_pin": ["relaylm/relaymem_primary_recall.py", "relaylm/relaymem_primary_current_state.py", "relaylm/_relaymem_primary_current_state_impl.py", "relaylm/relaymem_primary_mutation_coordinator.py", "relaylm/relaymem_primary_forget*", "relaylm/_relaymem_primary_forget*", "relaylm/relaymem_primary_correction.py", "relaylm/relaymem_primary_pin.py", "relaylm/relaymem_primary_lifecycle_page.py", "relaylm/_relaymem_primary_lifecycle_page_writer.py", "relaylm/relaymem_primary_retrieval_eligibility.py", "scripts/relaylm_phase_i1_*", "scripts/relaylm_phase_i3_*", "scripts/relaylm_phase_i4*", "scripts/_relaylm_phase_i4*", "scripts/relaylm_phase_i5a_*", "docs/architecture/phase_i[1-5]*", "docs/evidence/implementation/i4d_completion_report.md", "docs/evidence/implementation/i4e_completion_report.md", "docs/evidence/implementation/i5a_completion_report.md"],
        "cross_slice_convergence": ["relaylm/relaymem_slp_scheduler_*", "relaylm/relaymem_primary_retrieval_eligibility.py", "scripts/relaylm_wave[2-3]_*", "scripts/relaylm_phase_i4d_security_smoke.py", "docs/evidence/implementation/i1ge_completion_report.md", "docs/evidence/implementation/i4d_completion_report.md", "docs/evidence/implementation/o1d1_completion_report.md", "docs/smoke/*"],
    },
    "runtime": {
    ...
    "ui": {
        ...
        "forget_lifecycle_regressions": ["relaylm/relaymem_primary_forget*", "relaylm/relaymem_primary_current_state.py", "scripts/relaylm_phase_i4[bcdef]_*", "docs/evidence/implementation/i4e_completion_report.md"],
        ...
        "pin_unpin": ["relaylm/relaymem_primary_pin*", "relaylm/soul_lab_memory_pin*", "scripts/relaylm_phase_i5[ab]_*", "apps/soul-lab/**/*pin*", "docs/architecture/phase_i5*", "docs/evidence/implementation/i5a_completion_report.md"],
        "held_governance": ["relaylm/relaymem_held_governance.py", "relaylm/soul_lab_held_governance.py", "relaylm/lab_held_governance_api.py", "scripts/relaylm_i7ab_*", "scripts/relaylm_phase_i7c_*", "apps/soul-lab/**/*held*", "docs/architecture/phase_i7*", "docs/evidence/implementation/i7ab_completion_report.md"],
        "lifecycle_visibility": ["relaylm/soul_lab_lifecycle_visibility_projection.py", "scripts/relaylm_ui_b1a_lifecycle_visibility_*", "apps/soul-lab/src/features/lifecycle/**", "apps/soul-lab/scripts/lifecycleVisibilitySmoke.mjs", "docs/evidence/implementation/ui_b1a_completion_report.md"],
    },
}
...
COMMANDS = {
    ...
    "runtime": {
        ...
        "subjective_mem_lifecycle": [["-m", "pytest", "-q", "tests/test_subjective_mem_runtime.py", "tests/test_subjective_mem_commit_runtime.py", "tests/test_subjective_mem_lifecycle_runtime.py", "tests/test_subjective_mem_forget_runtime.py", "tests/test_subjective_mem_pin_runtime.py", "tests/test_subjective_mem_consolidate_runtime.py"], ["scripts/relaylm_lc1a_subjective_mem_correct_smoke.py"], ["scripts/relaylm_subjective_mem_forget_smoke.py"], ["scripts/relaylm_subjective_mem_pin_unpin_smoke.py"], ["scripts/relaylm_subjective_mem_consolidate_smoke.py"]],
    },
    "ui": {
