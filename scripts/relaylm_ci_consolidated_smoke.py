...
GROUPS = {
    "relaymem": {
        "primary_memory": [
            "relaylm/relaymem_primary_*",
            "relaylm/_relaymem_primary_*",
            "scripts/relaylm_relaymem_primary_*",
            "docs/architecture/relaymem_m3*",
        ...
        "slp_queue": [
            ...
            "relaylm/relaymem_slp_queue_*",
            "relaylm/relaymem_slp_runtime_*",
            "relaylm/relaymem_slp_finalized_turn_source.py",
            "scripts/relaylm_phase6b[0-3]*",
            "scripts/relaylm_phase6_runtime_enqueue_*",
            "scripts/relaylm_relaymem_slp_*",
            "docs/architecture/phase6a2_*",
            "docs/architecture/phase6b*",
            "docs/architecture/phase6_i1b_*",
        ],
        "durable_finalization": [
            "relaylm/*durable_finalization*",
            "relaylm/relaymem_slp_durable_runtime_enqueue.py",
            "scripts/relaylm_i1g*",
            "scripts/_relaylm_i1ge_*",
            "docs/architecture/i1g_*",
            "docs/mvp/wave3/i1ge_completion_report.md",
        ],
        "scheduler_worker": [
            "relaylm/relaymem_slp_primary_worker*",
            "relaylm/_relaymem_slp_primary_worker*",
            "relaylm/relaymem_slp_protected_source_store.py",
            "relaylm/_relaymem_slp_protected_source_*",
            "relaylm/relaymem_slp_one_queued_job_runner.py",
            "relaylm/relaymem_slp_scheduler_*",
            "relaylm/local_worker*",
            "relaylm/relaymem_held_governance_*",
            "scripts/relaylm_phase6c1_*",
            "scripts/_relaylm_phase6c1_*",
            "scripts/relaylm_phase6c2_*",
            "scripts/relaylm_o[01]*",
            "scripts/_relaylm_o[01]*",
            "scripts/relaylm_i7ab_*",
            "tests/test_relaymem_held_governance_preflight.py",
            "docs/architecture/o[01]*",
            "docs/architecture/phase6c*",
            "docs/architecture/phase_i7ab_*",
        ],
        "recall_correction_forget_pin": [
            ...
            "relaylm/relaymem_primary_forget*",
            "relaylm/_relaymem_primary_forget*",
            ...
            "scripts/relaylm_phase_i3_*",
            "scripts/relaylm_phase_i4*",
            "scripts/_relaylm_phase_i4*",
            "scripts/relaylm_phase_i5a_*",
            "docs/architecture/phase_i[1-5]*",
            "docs/mvp/wave[3-4]/*",
        ],
        "cross_slice_convergence": [
            "relaylm/relaymem_slp_scheduler_*",
            "relaylm/relaymem_primary_retrieval_eligibility.py",
            "scripts/relaylm_wave[2-3]_*",
    ...
    "runtime": {
        "client_instruction": [
            "relaylm/client_instruction_*",
            "relaylm/audit_projection.py",
            "relaylm/pipeline_context.py",
            "scripts/relaylm_client_instruction_*",
            "docs/architecture/phase5c4b_*",
        ],
        "relayctx_tts_stream": [
            "relaylm/adapter.py",
            "relaylm/relayctx_*",
            "scripts/relaylm_relayctx_*",
            "docs/architecture/phase5_5_*",
            "docs/architecture/phase55*",
        ],
        "relayrun_lazy_recovery": [
            "relaylm/relayrun_lazy_recovery.py",
            "scripts/relaylm_relayrun_*",
            "docs/architecture/phase5d2_*",
        ],
        "token_estimation": [
            "relaylm/*token*",
            "relaylm/relaymem_runtime_ctx.py",
            "scripts/relaylm_*token*",
            "scripts/relaylm_cjk_*",
            "scripts/relaylm_fullwidth_*",
            "scripts/relaylm_relaymem_cjk_*",
            "docs/architecture/phase5d1_*",
        ],
        "merged_review_residuals": [
            ...
            "relaylm/relaymem_store.py",
            "relaylm/_relaymem_store_impl.py",
            "relaylm/_client_instruction_cache_write_impl.py",
            "scripts/relaylm_merged_review_residuals_smoke.py",
            "scripts/relaylm_m3c_operation_index_normalization_smoke.py",
        ],
        "e1r1_trusted_home_scene_admission": [
            "scripts/relaylm_e1r1_*",
            "docs/architecture/e1r1_*",
            "docs/mvp/wave6/e1r1_*",
        ],
        "e1r2_character_store_bootstrap": [
            "relaylm/character_store_bootstrap*",
            "scripts/relaylm_e1r2_*",
            "docs/architecture/e1r2_*",
            "docs/mvp/wave6/e1r2_*",
        ],
        "soul_lab_management": [
    ...
    "ui": {
        ...
        "lab_observation": [
            ...
            "scripts/relaylm_phase_i2_*",
            "apps/soul-lab/src/features/lab/observation*",
            "apps/soul-lab/scripts/observation*",
        ],
        "lab_observation_regressions": [
            "relaylm/relaymem_slp_primary_worker*",
            "relaylm/relaymem_slp_one_queued_job_runner.py",
            "scripts/relaylm_phase6c[12]_*",
            "scripts/relaylm_phase_i1_*",
            "scripts/relaylm_phase_i2_*",
        ],
        ...
        "primary_mem_correct": [
            "relaylm/relaymem_primary_correction.py",
            "scripts/relaylm_phase_i3_*",
            "scripts/_relaylm_phase_i3_*",
        ],
        "primary_mem_correct_regressions": [
            "relaylm/relaymem_primary_*",
            "relaylm/_relaymem_primary_*",
            "scripts/relaylm_relaymem_primary_*",
            "scripts/relaylm_phase_i3_*",
        ...
        "primary_mem_correct_frontend": [
            "apps/soul-lab/src/features/lab/correction*",
            "apps/soul-lab/scripts/correction*",
            "apps/soul-lab/package*.json",
        ],
        "home_conversation_frontend": [
            "apps/soul-lab/src/features/home/**",
            "apps/soul-lab/scripts/*home*",
            "apps/soul-lab/package*.json",
        ],
        "home_conversation_regressions": [
            "relaylm/app.py",
            "relaylm/config.py",
            "scripts/relaylm_openwebui_lmstudio_*",
            "scripts/relaylm_documentation_current_boundary_smoke.py",
        ],
        "forget_lifecycle": [
            "relaylm/relaymem_primary_forget*",
            "relaylm/relaymem_primary_retrieval_eligibility.py",
            "scripts/relaylm_phase_i4d_*",
        ],
        "forget_lifecycle_regressions": [
            "relaylm/relaymem_primary_forget*",
            "relaylm/relaymem_primary_current_state.py",
            "scripts/relaylm_phase_i4[bcdef]_*",
        ],
        "forget_lifecycle_frontend": [
            "apps/soul-lab/src/features/**/usedMemoryLifecycle*",
            "apps/soul-lab/scripts/*forget*",
            "apps/soul-lab/scripts/*usedMemory*",
            "apps/soul-lab/package*.json",
        ],
        "pin_unpin": [
            "relaylm/relaymem_primary_pin*",
            "relaylm/soul_lab_memory_pin*",
            "scripts/relaylm_phase_i5[ab]_*",
            "apps/soul-lab/**/*pin*",
            "docs/architecture/phase_i5*",
        ],
        "held_governance": [
            ...
            "scripts/relaylm_i7ab_*",
            "scripts/relaylm_phase_i7c_*",
            "apps/soul-lab/**/*held*",
            "docs/architecture/phase_i7*",
        ],
        "lifecycle_visibility": [
            "relaylm/soul_lab_lifecycle_visibility_projection.py",
            "scripts/relaylm_ui_b1a_lifecycle_visibility_*",
            "apps/soul-lab/src/features/lifecycle/**",
...
COMMANDS: dict[str, dict[str, list[list[str]]]] = {
    "relaymem": {
        "primary_memory": [
            ...
            ["scripts/relaylm_relaymem_primary_index_log_recovery_audit_receipt_smoke.py"],
            ...
            ["scripts/relaylm_relaymem_primary_pipeline_result_validation_smoke.py"],
            ["scripts/relaylm_relaymem_primary_formation_dry_run_smoke.py"],
            ["scripts/relaylm_relaymem_primary_write_preflight_smoke.py"],
            ["scripts/relaylm_relaymem_primary_page_candidate_smoke.py"],
        ...
        "slp_queue": [
            ...
            ["scripts/relaylm_phase6b3_enqueue_lifecycle_compat_smoke.py"],
            ["scripts/relaylm_phase6b3_precommit_failure_projection_smoke.py"],
            ["scripts/relaylm_phase6b3_queue_root_path_smoke.py"],
        ...
        "scheduler_worker": [
            ...
            ["scripts/relaylm_phase6c1_primary_worker_review_fix_smoke.py"],
            ["scripts/relaylm_phase6c1_worker_integration_ci_runner.py"],
            ["scripts/relaylm_onboarding_config_smoke.py"],
            ...
            ["scripts/relaylm_phase_i2_lab_observation_smoke.py"],
            ...
            ["scripts/relaylm_mvp_completion_report_smoke.py", "docs/mvp/wave6/o1f_completion_report.md"],
            ["scripts/relaylm_mvp_completion_report_pr_link_smoke.py"],
            ["-m", "pytest", "tests/test_relaymem_held_governance_preflight.py"],
        ...
        "recall_correction_forget_pin": [
            ...
            ["scripts/relaylm_relaymem_selection_dry_run_smoke.py"],
            ["scripts/relaylm_relaymem_ctx_injection_plan_dry_run_smoke.py"],
            ["scripts/relaylm_relaymem_runtime_ctx_injection_smoke.py"],
            ["scripts/relaylm_relaymem_snippet_runtime_injection_apply_smoke.py"],
            ["scripts/relaylm_phase_i4b_ci_runner.py"],
            ["scripts/relaylm_phase_i3_primary_mem_correct_ci_runner.py"],
            ["scripts/relaylm_phase_i1_two_turn_primary_recall_smoke.py"],
            ["scripts/relaylm_phase_i4_forget_hide_contract_smoke.py"],
            ["scripts/relaylm_phase_i4c1_primary_forget_hidden_successor_smoke.py"],
            ["scripts/relaylm_phase_i4c1_primary_forget_corrected_revision_smoke.py"],
            ["scripts/relaylm_phase_i4c1_primary_forget_fault_smoke.py"],
            ["scripts/relaylm_phase_i4c1_primary_forget_concurrency_smoke.py"],
            ["scripts/relaylm_phase_i4c1_primary_forget_security_smoke.py"],
            ["scripts/relaylm_documentation_current_boundary_smoke.py"],
            ["scripts/relaylm_phase_i4c2_primary_forget_recovery_smoke.py"],
            ["scripts/relaylm_phase_i4c2_primary_forget_fault_smoke.py"],
            ["scripts/relaylm_phase_i4c2_primary_forget_concurrency_smoke.py"],
            ["scripts/relaylm_phase_i4c2_primary_forget_security_smoke.py"],
            ["scripts/relaylm_phase_i4c2_ownership_boundary_smoke.py"],
            ...
            ["scripts/relaylm_phase_i3_primary_mem_correct_smoke.py"],
            ["scripts/relaylm_phase_i3_primary_mem_correct_security_smoke.py"],
            ["scripts/relaylm_phase_i4b_primary_forget_preflight_smoke.py"],
            ["scripts/relaylm_phase_i4d_primary_retrieval_exclusion_smoke.py"],
        ],
        "cross_slice_convergence": [
    ...
    "runtime": {
        "client_instruction": [
            ["scripts/relaylm_client_instruction_relayscn_projection_smoke.py"],
            ["scripts/relaylm_client_instruction_cache_lookup_runtime_smoke.py"],
            ["scripts/relaylm_client_instruction_typed_parse_cache_write_smoke.py"],
            ["scripts/relaylm_client_instruction_cache_write_runtime_smoke.py"],
        ],
        "relayctx_tts_stream": [
        ...
        "relayrun_lazy_recovery": [
            ["scripts/relaylm_relayrun_lazy_recovery_detail_smoke.py"],
            ["scripts/relaylm_relayrun_lazy_recovery_runtime_wiring_smoke.py"],
        ...
        "token_estimation": [
            ...
            ["scripts/relaylm_token_budget_truncation_smoke.py"],
            ["scripts/relaylm_token_budget_truncation_dry_run_smoke.py"],
            ["scripts/relaylm_token_budget_truncation_apply_smoke.py"],
            ["scripts/relaylm_token_budget_truncation_proxy_smoke.py"],
        ],
        "merged_review_residuals": [
            ["scripts/relaylm_merged_review_residuals_smoke.py"],
            ["scripts/relaylm_m3c_operation_index_normalization_smoke.py"],
        ...
        "e1r1_trusted_home_scene_admission": [
            ...
            ["scripts/relaylm_mvp_completion_report_smoke.py", "docs/mvp/wave6/e1r1_completion_report.md"],
        ],
        "e1r2_character_store_bootstrap": [
            ["scripts/relaylm_e1r2_character_store_bootstrap_smoke.py"],
            ["scripts/relaylm_mvp_completion_report_smoke.py", "docs/mvp/wave6/e1r2_completion_report.md"],
            ["scripts/relaylm_mvp_completion_report_pr_link_smoke.py"],
            ["scripts/relaylm_docs_link_check.py"],
        ],
        "soul_lab_management": [
    ...
    "ui": {
        ...
        "forget_lifecycle": [
            ...
            ["scripts/relaylm_phase_i4d_historical_projection_smoke.py"],
            ["scripts/relaylm_phase_i4d_security_smoke.py"],
        ...
        "forget_lifecycle_regressions": [
            ...
            ["scripts/relaylm_mvp_completion_report_smoke.py", "docs/mvp/wave5/i4f_completion_report.md"],
        ],
        "pin_unpin": [
            ["scripts/relaylm_phase_i5a_pin_unpin_contract_smoke.py"],
...
def changed_outputs(workflow: str, files: list[str], force_all: bool) -> dict[str, bool]:
    ...
    return {
        group: any(matches(path, patterns) for path in files)
