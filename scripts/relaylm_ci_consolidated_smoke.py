...
GROUPS = {
    "relaymem": {
        "primary_memory": ["relaylm/relaymem_primary_*", "relaylm/_relaymem_primary_*", "scripts/relaylm_relaymem_primary_*", "docs/architecture/relaymem_m3*", "docs/contracts/slp/primary-worker.md", "docs/architecture/memory/formation.md"],
        "slp_queue": ["relaylm/relaymem_slp_job_admission.py", "relaylm/relaymem_slp_response_handoff.py", "relaylm/relaymem_slp_dispatch_preflight.py", "relaylm/relaymem_slp_durable_enqueue.py", "relaylm/relaymem_slp_queue_*", "relaylm/relaymem_slp_runtime_*", "relaylm/relaymem_slp_finalized_turn_source.py", "scripts/relaylm_phase6b[0-3]*", "scripts/relaylm_phase6_runtime_enqueue_*", "scripts/relaylm_relaymem_slp_*", "docs/architecture/phase6a2_*", "docs/architecture/phase6b*", "docs/contracts/governed-source-capture-admission.md"],
...
COMMANDS = {
    ...
    "runtime": {
        ...
        "e1r1_trusted_home_scene_admission": [["scripts/relaylm_e1r1_trusted_home_scene_admission_smoke.py"]],
        "e1r2_character_store_bootstrap": [["scripts/relaylm_e1r2_character_store_bootstrap_smoke.py"], ["scripts/relaylm_mvp_completion_report_pr_link_smoke.py"], ["scripts/relaylm_docs_link_check.py"]],
