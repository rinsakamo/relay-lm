...
RETIRED = "docs/architecture/phase_i4c1_primary_forget_hidden_successor.md"
CANONICAL = "docs/evidence/implementation/i4c1-primary-forget-hidden-successor-handoff.md"
