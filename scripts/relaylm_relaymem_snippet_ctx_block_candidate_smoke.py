...
from relaylm.retrieval.snippet import _build_ctx_block_snippet_candidate
...
def _assert_blocked_candidates(root: Path) -> None:
    ...
    unresolved = _artifact_for(root, relayint_intent_artifact={"unresolved_reference_detected": True})
