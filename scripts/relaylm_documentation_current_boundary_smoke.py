...
R2A_COMPLETION_ANCHORS = {
    STATUS: (
        ...
        "The mandatory R2A P8 current-authority synchronization is the current Lane C transaction as Draft PR #0000.",
    ...
    PLAN: (
        "current mandatory R2A P8 current-authority synchronization Draft PR #0000",
    ...
    RT1C: (
        ...
        "The mandatory RT-1D-R2A P8 current-authority synchronization is the current Lane C transaction as Draft PR #0000.",
        "It is documentation-only, requires no further P8",
...
def self_test() -> None:
    ...
    focused_mutations = (
        ...
        (PLAN, "current mandatory R2A P8 current-authority synchronization Draft PR #0000", "mandatory R2A P8 not started", "current P8 binding"),
