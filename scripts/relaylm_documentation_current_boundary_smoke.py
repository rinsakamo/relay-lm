...
R2_LIVE_ROOT_ANCHORS = {
    ...
    PLAN: (
        ...
        "PR #804",
        "The RT-1D-R2B P8 gate is current and RT-1D-R2C remains not started",
...
R2A_COMPLETION_ANCHORS = {
    STATUS: (
        ...
        "The mandatory R2B P8 current-authority synchronization is the current Lane C transaction as Draft PR #812.",
    ...
    RT1C: (
        ...
        "The mandatory RT-1D-R2B P8 current-authority synchronization is the current Lane C transaction as Draft PR #812.",
        "It is documentation-only, requires no further P8",
...
def self_test() -> None:
    ...
    focused_mutations = (
        ...
        (PLAN, "The RT-1D-R2B P8 gate is current and RT-1D-R2C remains not started", "the PR #806 queued-runner root budget amendment gate remains current and R2 remains not started", "stale PR #806 current gate"),
