...
REQUIRED = {
    "docs/PROJECT_STATUS.md": (
        ...
        "RT-1D-S2 worker seams                    next prerequisite after exact PR #790 resulting-main verification",
    ...
    "docs/architecture/project_execution_plan.md": (
        ...
        "RT-1D-S2 worker seams is the next executable Lane C prerequisite only after the exact resulting main of PR #790 is independently verified.",
...
PROBES = (
    ...
    (STATUS, "S1 mandatory P8 current-authority sync      PR #790; verify exact resulting main"),
    ...
    (PLAN, "S1 mandatory P8 current-authority sync in PR #790 -> verify exact resulting main"),
