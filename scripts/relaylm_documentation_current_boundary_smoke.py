...
REQUIRED = {
    "docs/PROJECT_STATUS.md": (
        ...
        "RT-1D-S1 reader seams                          complete in PR #789; behavior-preserving; mandatory P8 and resulting-main verification pending",
        "RT-1D-S2 worker seams                       next prerequisite only after S1 P8 merges and resulting main is verified",
        ...
        "RT-1 is in progress with RT-1A, RT-1B, RT-1C, and the behavior-preserving RT-1D-S1 reader seams complete; RT-1D hard cutover and retirement is architecture-authorized but runtime remains not started.",
    ...
    "docs/architecture/project_execution_plan.md": (
        ...
        "RT-1D-S2 worker seams next only after S1 P8 merges and resulting main is verified",
        ...
        "RT-1D-S2 worker seams is the next executable Lane C prerequisite only after the mandatory S1 P8 merges and its resulting main is verified.",
        "implementation program is complete through RT-1D-S1",
        "RT-1D-S1 reader seams completed in PR #789",
        "Primary MEM remains the sole ordinary served memory and Retrieval authority, and RT-1D runtime remains not started",
...
PROBES = (
    ...
    (STATUS, "RT-1D-S1 reader seams                          complete in PR #789; behavior-preserving; mandatory P8 and resulting-main verification pending"),
