...
REQUIRED = {
    "docs/PROJECT_STATUS.md": (
        ...
        "RT-1 is in progress with RT-1A, RT-1B, and RT-1C complete; RT-1D hard cutover and retirement is architecture-authorized as the next ordered Lane C slice and is not started.",
...
PROBES = (
    ...
    (STATUS, "RT-1D hard cutover and retirement                  next ordered Lane C slice; architecture-authorized / not started"),
    ...
    (PLAN, "RT-1D hard cutover and retirement next ordered Lane C slice / architecture-authorized / not started"),
