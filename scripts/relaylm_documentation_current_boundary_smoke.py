...
REQUIRED = {
    ...
    "docs/architecture/project_execution_plan.md": (
        ...
        "RT-1D-S3B Forget core seams completed in PR #796 with exact resulting main `b75df848bf3982e00f67969c016ba1f28dd93427`; this transaction is the mandatory S3B P8 current-authority synchronization.",
...
S3_AMENDMENT_ANCHORS = {
    ...
    "docs/architecture/subjective-mem-retrieval-projection-hard-cutover.md": (
        ...
        "S3B is complete in PR #796, and this transaction is the mandatory S3B P8 current-authority synchronization.",
...
S3A_COMPLETION_ANCHORS = {
    ...
    "docs/architecture/subjective-mem-retrieval-projection-hard-cutover.md": (
        ...
        "S3B is complete in PR #796, and this transaction is the mandatory S3B P8 current-authority synchronization.",
        "S3C is next but has not started; it becomes executable only after this P8 merges",
...
S3B_COMPLETION_ANCHORS = {
    "docs/PROJECT_STATUS.md": (
        ...
        "Primary MEM remains the sole ordinary served memory and Retrieval authority",
        "this transaction is the mandatory S3B P8 current-authority synchronization",
    ...
    "docs/architecture/project_execution_plan.md": (
        ...
        "this transaction is the mandatory S3B P8 current-authority synchronization",
        "S3C is next but has not started and is not executable until this P8 merges and its exact resulting main is independently verified",
        "No Lane C transaction overlaps",
    ),
    "docs/architecture/subjective-mem-retrieval-projection-hard-cutover.md": (
        "S3B implementation PR #796 result b75df848bf3982e00f67969c016ba1f28dd93427",
        "mandatory S3B P8 current-authority synchronization in this transaction",
        "independently verify this P8 exact resulting main",
