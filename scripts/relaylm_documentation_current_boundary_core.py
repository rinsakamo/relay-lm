...
REQUIRED = {
    ...
    "docs/evidence/implementation/i4f_completion_report.md": (
        ...
        "frozen implementation evidence",
        "i4f_completion_report-source.txt",
        "no post-source report modification exists",
    ...
    "docs/evidence/implementation/o1d2_completion_report.md": (
        ...
        "frozen implementation evidence",
        "o1d2_completion_report-source.txt",
        "4dc151989f0a918f51e2036c1ee55c8f438f811c",
        "this cutover adds no scheduling or operational behavior",
    ),
    "docs/evidence/implementation/i4e_completion_report.md": (
        "relaylm_doc_type: implementation_completion_report",
        ...
        "frozen implementation evidence",
        "i4e_completion_report-source.txt",
        "No post-source report modification exists",
        "this cutover changes documentation and validation paths only",
    ),
    "docs/evidence/implementation/ui_b1a_completion_report.md": (
        "relaylm_doc_type: implementation_completion_report",
        ...
        "frozen implementation evidence",
        "ui_b1a_completion_report-source.txt",
        "No post-source report modification exists",
        "this cutover introduces no UI or API behavior",
    ),
    "docs/evidence/implementation/i5a_completion_report.md": (
        "relaylm_doc_type: implementation_completion_report",
        ...
        "frozen implementation evidence",
        "i5a_completion_report-source.txt",
        "No post-source report modification exists",
        "this cutover changes documentation and validation paths only",
    ),
    "docs/evidence/implementation/i7ab_completion_report.md": (
        ...
        "frozen implementation evidence",
        "i7ab_completion_report-source.txt",
        "No post-source report modification exists",
        "this cutover changes documentation and validation paths only",
    ),
    "docs/architecture/o1f_operational_validation.md": (
    ...
    "docs/evidence/implementation/i1ge_completion_report.md": (
        ...
        "frozen implementation evidence",
        "i1ge_completion_report-source.txt",
        "No post-source report modification exists",
    ),
    "docs/evidence/implementation/i4d_completion_report.md": (
        "relaylm_doc_type: implementation_completion_report",
        ...
        "frozen implementation evidence",
        "i4d_completion_report-source.txt",
        "No post-source report modification exists",
    ),
    "docs/evidence/implementation/o1d1_completion_report.md": (
        "relaylm_doc_type: implementation_completion_report",
        ...
        "frozen implementation evidence",
        "o1d1_completion_report-source.txt",
        "No post-source report modification exists",
    ),
}
