...
```mermaid
graph LR
  actual_model_crystallization_llama_cpp --> actual_model_evaluation
  actual_model_crystallization_llama_cpp --> actual_model_llama_cpp_qualification
  actual_model_crystallization_llama_cpp --> crystallization
  actual_model_crystallization_llama_cpp --> physical_execution_queue
  actual_model_crystallization_llama_cpp --> provider_and_api
  actual_model_evaluation --> cognitive_budget
  actual_model_evaluation --> cognitive_turn
  actual_model_evaluation --> continuity_context
  actual_model_evaluation --> crystallization
  actual_model_evaluation --> memory_provenance
  actual_model_evaluation --> persistence
  actual_model_evaluation --> provider_and_api
  actual_model_evaluation --> runtime_configuration
  actual_model_evaluation --> state_and_validation
  actual_model_llama_cpp_qualification --> actual_model_evaluation
  actual_model_llama_cpp_qualification --> cognitive_turn
  actual_model_llama_cpp_qualification --> provider_and_api
  actual_model_vllm_reference_production --> actual_model_evaluation
  ...
  cognitive_turn --> core_architecture
  cognitive_turn --> knowledge
  cognitive_turn --> provider_and_api
  cognitive_turn --> state_and_validation
  context_compiler --> continuity_context
  context_compiler --> core_architecture
  ...
  continuity_label_invariance_diagnostic --> actual_model_evaluation
  continuity_label_invariance_diagnostic --> actual_model_llama_cpp_qualification
  continuity_label_invariance_diagnostic --> cognitive_turn
  continuity_label_invariance_diagnostic --> fixed_continuity_slot_diagnostic
  continuity_label_invariance_diagnostic --> lm_studio_semantic_first_qualification
  crystallization --> core_architecture
  crystallization --> memory_provenance
  crystallization --> persistence
  crystallization --> provider_and_api
  crystallization --> state_and_validation
  epistemic_formation_diagnostic --> actual_model_evaluation
  epistemic_formation_diagnostic --> actual_model_llama_cpp_qualification
  epistemic_formation_diagnostic --> cognitive_turn
  epistemic_formation_diagnostic --> continuity_context
  ...
  evaluation --> provider_and_api
  evaluation --> runtime_configuration
  evaluation --> state_and_validation
  external_qualification --> physical_execution_queue
  external_qualification --> release_engineering
  fixed_continuity_slot_diagnostic --> actual_model_evaluation
  fixed_continuity_slot_diagnostic --> cognitive_turn
  fixed_continuity_slot_diagnostic --> lm_studio_semantic_first_qualification
  knowledge --> core_architecture
  lab_environment --> actual_model_evaluation
  lab_environment --> external_qualification
  lm_studio_semantic_first_qualification --> actual_model_evaluation
  lm_studio_semantic_first_qualification --> cognitive_turn
  lm_studio_semantic_first_qualification --> provider_and_api
  ...
  production_continuity_only_diagnostic --> production_continuity_overlay_diagnostic
  production_continuity_only_diagnostic --> provider_and_api
  production_continuity_only_physical --> actual_model_evaluation
  production_continuity_only_physical --> actual_model_llama_cpp_qualification
  production_continuity_only_physical --> production_continuity_only_diagnostic
  production_continuity_only_physical --> two_turn_diagnostic_carriage
  production_continuity_overlay_diagnostic --> actual_model_evaluation
  production_continuity_overlay_diagnostic --> actual_model_llama_cpp_qualification
  production_continuity_overlay_diagnostic --> continuity_context
  production_continuity_overlay_diagnostic --> semantic_continuity_projection_physical
  production_continuity_overlay_diagnostic --> two_turn_diagnostic_carriage
  production_unresolved_no_pass1_diagnostic --> actual_model_evaluation
  production_unresolved_no_pass1_diagnostic --> continuity_context
  production_unresolved_no_pass1_diagnostic --> production_continuity_only_diagnostic
  production_unresolved_no_pass1_diagnostic --> production_continuity_overlay_diagnostic
  production_unresolved_no_pass1_diagnostic --> production_unresolved_only_diagnostic
  production_unresolved_no_pass1_diagnostic --> provider_and_api
  production_unresolved_no_pass1_no_accepted_continuity_diagnostic --> actual_model_evaluation
  production_unresolved_no_pass1_no_accepted_continuity_diagnostic --> continuity_context
  production_unresolved_no_pass1_no_accepted_continuity_diagnostic --> production_continuity_overlay_diagnostic
  production_unresolved_no_pass1_no_accepted_continuity_diagnostic --> production_unresolved_no_pass1_diagnostic
  production_unresolved_no_pass1_no_accepted_continuity_diagnostic --> production_unresolved_only_diagnostic
  production_unresolved_no_pass1_no_accepted_continuity_diagnostic --> provider_and_api
  production_unresolved_no_pass1_no_accepted_continuity_physical --> actual_model_evaluation
  production_unresolved_no_pass1_no_accepted_continuity_physical --> actual_model_llama_cpp_qualification
  production_unresolved_no_pass1_no_accepted_continuity_physical --> physical_execution_queue
  production_unresolved_no_pass1_no_accepted_continuity_physical --> production_unresolved_no_pass1_no_accepted_continuity_diagnostic
  production_unresolved_no_pass1_no_accepted_continuity_physical --> production_unresolved_no_pass1_physical
  production_unresolved_no_pass1_no_accepted_continuity_physical --> two_turn_diagnostic_carriage
  production_unresolved_no_pass1_physical --> actual_model_evaluation
  production_unresolved_no_pass1_physical --> actual_model_llama_cpp_qualification
  production_unresolved_no_pass1_physical --> physical_execution_queue
  production_unresolved_no_pass1_physical --> production_unresolved_no_pass1_diagnostic
  production_unresolved_no_pass1_physical --> production_unresolved_only_physical
  production_unresolved_no_pass1_physical --> two_turn_diagnostic_carriage
  production_unresolved_only_diagnostic --> actual_model_evaluation
  production_unresolved_only_diagnostic --> continuity_context
  production_unresolved_only_diagnostic --> production_continuity_only_diagnostic
  production_unresolved_only_diagnostic --> provider_and_api
  production_unresolved_only_physical --> actual_model_evaluation
  production_unresolved_only_physical --> actual_model_llama_cpp_qualification
  production_unresolved_only_physical --> production_unresolved_only_diagnostic
  production_unresolved_only_physical --> two_turn_diagnostic_carriage
  provider_and_api --> core_architecture
  release_engineering --> evaluation
  release_engineering --> runtime_configuration
  release_engineering --> starter_packages
  repository_authority --> development_workflow
  runtime_configuration --> cognitive_budget
  runtime_configuration --> cognitive_turn
  runtime_configuration --> continuity_context
  runtime_configuration --> persistence
  runtime_configuration --> provider_and_api
  semantic_continuity_projection_diagnostic --> actual_model_evaluation
  semantic_continuity_projection_diagnostic --> continuity_context
  semantic_continuity_projection_diagnostic --> epistemic_formation_diagnostic
  semantic_continuity_projection_physical --> actual_model_llama_cpp_qualification
  semantic_continuity_projection_physical --> semantic_continuity_projection_diagnostic
  starter_packages --> knowledge
  starter_packages --> persistence
  state_and_validation --> core_architecture
  two_turn_diagnostic_carriage --> actual_model_evaluation
  two_turn_diagnostic_carriage --> actual_model_llama_cpp_qualification
  two_turn_diagnostic_carriage --> cognitive_turn
  two_turn_diagnostic_carriage --> continuity_context
  core_architecture
  development_workflow
```
