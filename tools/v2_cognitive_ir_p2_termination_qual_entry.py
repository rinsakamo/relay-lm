...
from tools import v2_cognitive_ir_p2_termination_qual_transaction as transaction


class P2TerminationQualificationEntryError(RuntimeError):
    """The active qualification entrypoint cannot reconcile its terminal summary."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if isinstance(summary_code, bool) or not isinstance(summary_code, int):
        return child_code if child_code != 0 else 3
    if summary.get("classification") == "P2_TERMINATION_QUALIFIED":
