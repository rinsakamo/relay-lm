...
def _load_listener_safe_transaction():
    """Activate R4 before shared transaction modules bind campaign identity."""

    activate_s3_r4_preregistration()
    transaction = importlib.import_module(
        "tools.v2_cognitive_ir_s3_llama_cpp_transaction"
    )
    transaction.S3_PREREGISTRATION_SHA256 = S3_R4_PREREGISTRATION_SHA256
    transaction.S3_LLAMA_CPP_MAX_OUTPUT_TOKENS = S3_R4_MAX_OUTPUT_TOKENS
    transaction.S3LlamaCppClient = S3R4LlamaCppClient
