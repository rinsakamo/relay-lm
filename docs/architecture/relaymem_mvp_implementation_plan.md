...
I1-GC one-record replay and completion convergence is complete outside RelayMEM lifecycle authority. I1-GD/I1-GE and O1B and O1D through O1F remain operations work.
...
O1A defines a pure replay-before-queue round with at most one future I1-GC delegation and at most one future C2 delegation. O1B and O1D through O1F remain unimplemented. Replay output is never a direct queue/C2 input.
