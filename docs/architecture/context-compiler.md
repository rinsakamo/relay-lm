...
- the bounded exact-leading-`not` rules do not define aliases, synonyms, contractions, `never`, double-negation semantics, omitted-key inference, multi-line heading negation, heading-plus-inline overlap semantics, multiple-assignment negation, boolean negation, reserved-degree negation, or broader natural-language negation;
