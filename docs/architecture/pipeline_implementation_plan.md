...
## Phase 5.5: Stream Unpack — complete through 5.5-A
...
C4b, C5, and RelaySOUL execution gates are not prerequisites for Phase 5.5-B.
...
New RelaySOUL execution-gate design documents should not be added before Phase 5.5-B is complete unless they directly unblock a current runtime safety issue. Existing RelaySOUL governance documents remain valid; this sequencing rule only freezes further design expansion.
