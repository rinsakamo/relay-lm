...
- **SM-1 Subjective MEM decision/result vertical slice** depends on ASM-1 and implements one end-to-end `create` path with exact assessment, character, scope, policy-revision, decision, result, and current-state linkage. Its accepted logical boundary is governed by [Shared Assessment and Subjective MEM Contract](../contracts/shared-assessment-subjective-mem.md): it remains default-off, character-private, prepared-only, non-retrievable, and stops before ST-1 canonical publication. Similarity remains candidate generation only. SOUL-conditioned proposal generation cannot become production-authoritative until PM-D1 is resolved.
- **ST-1 Markdown + operations commit protocol** depends on the SM-1 record shape and implements the first canonical `create` publication using a prepared immutable post-image, canonical Markdown, a matching durable operations receipt, scoped idempotency, digest-based caller-invoked recovery, and rebuildable projection fencing. Its accepted logical and physical boundaries are governed by [Subjective MEM Storage Authority and Commit Protocol](../contracts/subjective-mem-storage-authority-and-commit-protocol.md) and [Subjective MEM Canonical Markdown v1](../contracts/subjective-mem-canonical-markdown-v1.md): it remains default-off, create-only, single-host, and POSIX-apply-only; logical Retrieval eligibility does not wire ordinary Retrieval.
...
```text
Lane R  R5 governed core package migration              COMPLETE
Lane D  D6 final retirement / cutover-tool retirement   D6-R34 failed completion audit complete (#1143); D6-R35 in progress — SOUL Lab A6/A7 source family retired (#1151), UI-A0/A1 + UI-A2 foundation/adoption source family retired (#1157), UI-A3/A4/A5 preview source family retired (#1162), UI-B0/B1A real Home conversation / lifecycle visibility source family retired (#1171), and I-4E/I-4F Forget plus I-7C Held governance source family retired (#1175), and I-5B Pin/Unpin apply/API/UI source family retired (#1181), and I-7A/B Held Apply/Discard preflight source family retired (#1184), and ACG-2 Grounded Recall detail-safety source family retired (#1188), and remaining ACG roadmap plus ACG-1/3/4/5/6 source family retired (#1195), and CW-A1/A2 source tree/parser/compiler source family retired (#1198), and CW-A5 plus target Character Template and Creation Flow creation/templates/import source family retired (#1201), and CW-A3 Character Workspace UI presentation source family retired (#1206), and Phase 5.5 stream/TTS bounded-slice source family retired (#1209), and CW-A4 maintenance implementation handoff retired (#1218), and Phase 6 A/B admission/response-handoff/durable-queue source family retired (#1221), and Phase 6-C worker/source-capture/finalization source family retired (#1223), and D6-R35-R Primary writer/index-log recovery source family retired (#1240), and D6-R35-S Shared Assessment/Subjective MEM runtime source family retired (#1244), and D6-R35-T Grounded Recall exact-contract promotion complete (#1249), and D6-R35-U E1 retrieval/grounding/evaluation-source handoff family retired (#1251), and D6-R35-V legacy stable Character / Relationship / Scene source family retired (#1253); D6-R35 in progress; D6-R35-W next; D6-R36 not started; D6 incomplete
Lane R  R6 Primary MEM disposition                      required cleanup after R5
Lane C                                                  idle until PD-2 completes
```

The D6-R35-N Character Workspace maintenance exact-contract promotion is complete in implementation PR #1215. Its mandatory P8 authority synchronization records that the stable maintenance responsibility remains in Character Workspace architecture and exact current candidate/proposal semantics are owned by docs/contracts/character-workspace/maintenance-candidates.md. D6-R35-O CW-A4 maintenance source retirement is complete in implementation PR #1218; the handoff is retired to Git history with its exact recovery identity in records/documentation/retirement-manifest.json, while the stable and exact permanent owners remain current. D6-R35-P Phase 6 A/B admission, response-handoff, dispatch-preflight, durable-enqueue, and queue-state source retirement is complete in implementation PR #1221; the permanent SLP job-admission, response-handoff, and durable-queue contracts remain current. D6-R35-Q Phase 6-C worker/source-capture/finalization source retirement is complete in implementation PR #1223; the permanent primary-worker, governed-source-capture, durable-finalization, and memory-formation owners remain current, and Primary writer, M3D/M3E, index/log recovery, and I1G transaction ownership remain outside Q. D6-R35-R Primary writer/index-log recovery source retirement is complete in implementation PR #1240; permanent storage/recovery and SLP durable-finalization owners remain current while runtime/code/test evidence remains protected. D6-R35-S Shared Assessment/Subjective MEM runtime source retirement is complete in implementation PR #1244; permanent formation, memory-subsystem, storage/recovery, lifecycle-publication, and Subjective MEM contract owners remain current while runtime/code/test evidence remains protected. D6-R35-T Grounded Recall exact-contract promotion is complete in implementation PR #1249; `docs/contracts/grounded-recall.md` is the exact owner while the E1-R4 handoff remains transitional evidence. D6-R35-U E1 retrieval/grounding/evaluation-source retirement is complete in implementation PR #1251; the E1-R4 and E1-R5 handoffs are retired with exact recovery identities in the retirement manifest while retrieval/grounding authorities and current evidence remain protected. D6-R35-V legacy stable Character / Relationship / Scene source-family retirement is complete in implementation PR #1253; the six pre-canonical stable design sources are retired with exact recovery identities in the retirement manifest while the permanent owners and protected runtime/code/test/evidence surfaces remain current. D6-R35 remains in progress, D6-R35-W is next eligible, D6 remains incomplete, and D6-R36 has not started.
...
The paragraph below is the retained historical record of the post-E1-R5 candidate state. Each of its present-tense progress and authority statements is scoped to the earlier point at which it was written and does not describe current state; the current position is RT-1 and Lane R R5 complete, with Lane R R6 next and Lane D advanced into D6 final retirement as recorded in [Post-RT-1 repository-wide sequencing](#post-rt-1-repository-wide-sequencing). The PM-D1, PM-D2, PM-D4, and PM-D9 decision debt it names does remain open.
