...
- [Current project status](PROJECT_STATUS.md) — concise current boundary through completed Phase I-3 and defined Phase I-4A contract
...
Phase I-4A does not extend this current runtime completion claim. Forget apply, lifecycle convergence, M2 exclusion, and the Forget UI remain unimplemented.
