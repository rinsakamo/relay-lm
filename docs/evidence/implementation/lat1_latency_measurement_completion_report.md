...
relaylm_source_commit: 85817a391e27492cd139bd75929a60e1065a1454
relaylm_source_origin_commit: c77cf8e37a3f52c67c523004cf2a37b4c28f62f8
relaylm_source_pr: 505
relaylm_recorded_on: 2026-07-07
relaylm_source_blob: 0bf5743b7ba0ac85e657bb06ae88b8f1d41b3936
relaylm_source_content_sha256: a33d190625ee5f6f4f9f74143f74cc6a505927b07175cf8aec00638e72b4db42
...
This document is frozen implementation evidence for the LAT-1 measurement slice introduced by PR #505, merged as `c77cf8e37a3f52c67c523004cf2a37b4c28f62f8`, and last aligned to the extracted RelayRUN artifact-module boundary by `85817a391e27492cd139bd75929a60e1065a1454`. Current repository status belongs to [Project Status](../../PROJECT_STATUS.md). Current timing schema and measurement behavior belong to [LAT-1 Latency Measurement](../../architecture/lat1_latency_measurement.md); the current retrieval-scaling reproduction method belongs to [LAT-1 Retrieval Scaling Method](../../evaluation/lat1-retrieval-scaling.md) (Cutover 1C-39 split the mixed method/template scaffold this report originally pointed at into that method document and [LAT-1 Retrieval Scaling Report Template](../../templates/evaluation/lat1-retrieval-scaling-report.md); no real scaling result exists at either destination).
...
PYTHONPATH=.:scripts python scripts/relaylm_mvp_completion_report_smoke.py docs/evidence/implementation/lat1_latency_measurement_completion_report.md
```
