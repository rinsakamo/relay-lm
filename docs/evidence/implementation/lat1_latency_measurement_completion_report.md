...
This document is frozen implementation evidence for the LAT-1 measurement slice introduced by PR #505, merged as `c77cf8e37a3f52c67c523004cf2a37b4c28f62f8`, and last aligned to the extracted RelayRUN artifact-module boundary by `85817a391e27492cd139bd75929a60e1065a1454`. Current repository status belongs to [Project Status](../../PROJECT_STATUS.md). Current timing schema and measurement behavior belong to [LAT-1 Latency Measurement](../../architecture/lat1_latency_measurement.md); current local retrieval-scaling observations belong to [LAT-1 Retrieval Scaling Report](../../evaluation/lat1_retrieval_scaling_report.md).
