...
- [MVP-43 RelayCTX short-term runtime injection apply gate](mvp43_relayctx_short_term_runtime_injection_apply_gate.md) — frozen apply-gate evidence from PR #237 (pre-cutover wording reworded 2026-06-11); its "historical RelayINT / RelayREF compatibility boundary" section is superseded by [PM-D6](../../architecture/pm_d6_relayint_native_artifact_relayref_wrapper_removal.md); current full gate/blocked-reason taxonomy remains [RelayCTX Short-Term Runtime Contract](../../contracts/relayctx_short_term_runtime_contract.md)-owned.
