...
- [Phase 5.5-A stream sentinel buffer dry run](phase55a-stream-sentinel-buffer-dry-run-handoff.md) — frozen implementation evidence from PR #311; current Stream Unpack boundary remains [Phase 5.5 Stream Unpack Bounded Slice](../../architecture/phase5_5_stream_unpack_bounded_slice.md)-owned.
...
- [Phase 5.5-C0 TTS segmentation helper](phase55c0-tts-segmentation-helper-handoff.md) — frozen helper implementation evidence from PR #314; current Stream Unpack sequencing remains [Phase 5.5 Stream Unpack Bounded Slice](../../architecture/phase5_5_stream_unpack_bounded_slice.md)-owned, and current C0 consumption/runtime handoff behavior remains C1/C2/code-owned.
- [Phase 5.5-C4 runtime TTS transport envelope wiring](phase55c4-runtime-tts-transport-envelope-wiring.md) — frozen runtime-wiring evidence from PR #327; current Stream Unpack sequencing remains [Phase 5.5 Stream Unpack Bounded Slice](../../architecture/phase5_5_stream_unpack_bounded_slice.md)-owned, and current runtime handoff/transport behavior remains C2/C3/code-owned.
