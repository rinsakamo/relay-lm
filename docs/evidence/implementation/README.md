...
- [I1-GE completion report](i1ge_completion_report.md) — frozen durable-finalization crash/restart validation evidence from PR #411; current behavior remains I1-G-contract-, I1-GD-, implementation-, and focused-smoke-owned.
- [I1-GE crash-validation governance handoff](i1ge-durable-finalization-crash-validation-handoff.md) — frozen validation-only governance evidence added by PR #415 for the PR #411 process-exit/fresh-restart proof; current production authority remains I1-G-contract-, I1-GD-, implementation-, and focused-smoke-owned.
- [Phase I-2 Real SOUL Lab Observation handoff](phase-i2-real-soul-lab-observation-handoff.md) — frozen observe-only implementation evidence from PR #377; current behavior remains SOUL Lab architecture-, implementation-, and focused-smoke-owned.
...
- [RelayMEM-M3a Primary Formation handoff](relaymem-m3a-primary-formation-handoff.md) — frozen helper-only Primary MEM formation-candidate evidence from implementation PR #324 and handoff PR #326; current behavior remains Primary-pipeline-, RelayMEM-design-, implementation-, and focused-smoke-owned.
- [I-4C1 Primary Forget hidden-successor handoff](i4c1-primary-forget-hidden-successor-handoff.md) — frozen bounded commit evidence from PR #396; current Forget behavior remains Phase-I-4-contract-, implementation-, I-4D/I-4E/I-4F-, and focused-smoke-owned.
- [I-4C2 Primary Forget recovery/finalization handoff](i4c2-primary-forget-recovery-finalization-handoff.md) — frozen recovery/finalization evidence from PR #404 plus concurrent-loser normalization from PR #407; current behavior remains Phase-I-4-contract-, implementation-, I-4D/I-4E/I-4F-, and focused-smoke-owned.
...
- [Docs Execution Plan Consolidation completion report](docs_execution_plan_consolidation_completion_report.md) — frozen docs-only execution-plan-and-roadmap-consolidation evidence from PR #422 (squash-merged, source and origin commit identical); no production boundary was implemented; current status remains [Project Status](../../PROJECT_STATUS.md)-owned and current MVP sequencing/post-MVP roadmap ordering remain [Project Execution Plan](../../architecture/project_execution_plan.md)-owned.
- [Phase 5.5-A stream sentinel buffer dry run](phase55a-stream-sentinel-buffer-dry-run-handoff.md) — frozen implementation evidence from PR #311; current Stream Unpack boundary remains [Voice Streaming and TTS Architecture](../../architecture/voice/streaming-and-tts.md)-owned.
- [Phase 5.5-B1 stream suppression gate](phase55b1-stream-suppression-gate-handoff.md) — frozen helper implementation evidence from PR #312; current Stream Unpack sequencing and request-runtime suppression behavior remain [Voice Streaming and TTS Architecture](../../architecture/voice/streaming-and-tts.md)-, implementation-, and focused-smoke-owned.
...
- [Phase 5.5-C0 TTS segmentation helper](phase55c0-tts-segmentation-helper-handoff.md) — frozen helper implementation evidence from PR #314; current Stream Unpack sequencing remains [Voice Streaming and TTS Architecture](../../architecture/voice/streaming-and-tts.md)-owned, and current C0 consumption/runtime handoff behavior remains C1/C2/code-owned.
- [Phase 5.5-C4 runtime TTS transport envelope wiring](phase55c4-runtime-tts-transport-envelope-wiring.md) — frozen runtime-wiring evidence from PR #327; current Stream Unpack sequencing remains [Voice Streaming and TTS Architecture](../../architecture/voice/streaming-and-tts.md)-owned, and current runtime handoff/transport behavior remains C2/C3/code-owned.
