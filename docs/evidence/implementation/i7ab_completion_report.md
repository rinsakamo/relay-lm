...
This is frozen implementation evidence for PR #423. Current behavior belongs to the [Held Apply / Discard Governance Contract](../../contracts/memory/held-governance.md), the production governance implementation, B3/C2/I-4 authorities, and the focused I-7A/B/I-7C smokes.
