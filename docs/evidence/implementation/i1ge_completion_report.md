...
relaylm_related_authority:
  - ../../architecture/i1ge_durable_finalization_crash_validation.md
...
This is frozen implementation evidence for PR #411. Current behavior belongs to [I1-GE Durable-finalization Crash Validation](../../architecture/i1ge_durable_finalization_crash_validation.md), the existing I1-GA through I1-GD durable-finalization production authorities, current replay/retention/scheduler/worker contracts, and the focused I1-GE crash/security/concurrency smokes.
...
- Current authority: [I1-GE Durable-finalization Crash Validation](../../architecture/i1ge_durable_finalization_crash_validation.md), I1-GA through I1-GD production authorities, and the focused I1-GE smokes.
