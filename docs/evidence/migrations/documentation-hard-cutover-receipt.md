...
verification:
  ...
  validated_content_head_triggered_check_runs: RECEIPT_PLACEHOLDER_CHECK_RUN_COUNT
  validated_content_head_all_github_actions: RECEIPT_PLACEHOLDER_STATUS
  ...
  unresolved_review_threads: 0
  validated_content_head: RECEIPT_PLACEHOLDER_NEW_VALIDATED_HEAD
  final_head: RECEIPT_PLACEHOLDER_FINAL_HEAD
  final_head_triggered_workflow_runs: RECEIPT_PLACEHOLDER_WORKFLOW_RUN_COUNT
  final_head_all_github_actions: RECEIPT_PLACEHOLDER_STATUS
  receipt_finalization: performed_after_validated_content_head
```
