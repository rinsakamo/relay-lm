...
- [OpenWebUI + LM Studio Manual Smoke Result — 2026-05-26](openwebui-lmstudio-manual-smoke-2026-05-26.md) — frozen local validation result moved from `docs/smoke/` in Cutover 1C-45; preserves run-specific observations as historical evidence.
...
(method: [LAT-1 Retrieval Scaling Method](../../operations/lat1-retrieval-scaling.md))
