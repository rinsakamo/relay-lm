...
- **D6-R35-N** is complete in implementation PR #1215 with this mandatory P8 authority synchronization. The exact current Character Workspace maintenance run, candidate, proposal, identifier, status, field, validation, write-candidate, approval, and public-projection semantics are now owned by docs/contracts/character-workspace/maintenance-candidates.md; stable responsibility remains in docs/architecture/character-workspace/maintenance-candidates.md; and the CW-A4 implementation handoff is the D6-R35-O retirement target. No runtime, API, schema implementation, test, workflow, retirement-manifest, Lane R/C, or source-retirement change is introduced, D6-R35 remains in progress, D6 remains incomplete, and D6-R36 has not started.
