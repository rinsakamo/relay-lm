...
Lane R  R6 Primary MEM classification baseline             COMPLETE; LR-D35-1 classification detachment COMPLETE (PR #1238); D6-R35-R next eligible but unstarted
...
The bounded Lane R classification-evidence detachment for `r6.primary.index_log_recovery` completed in PR #1233. M3H remains live evidence, the active asset and its runtime/code/test evidence remain protected, and D6-R35-R remains unstarted.
