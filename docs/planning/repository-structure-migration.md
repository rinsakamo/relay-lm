...
Lane R  R6 Primary MEM classification baseline             COMPLETE; LR-D35-1 classification detachment COMPLETE (PR #1238); D6-R35-R complete (PR #1240); D6-R35-S complete (PR #1244); D6-R35-T next eligible
...
The bounded Lane R classification-evidence detachment for `r6.primary.index_log_recovery` completed in PR #1233. D6-R35-R subsequently retired the former M3D–M3H and I1-G/I1-GD architecture handoffs in PR #1240, and D6-R35-S retired the former ASM-1, SM-1, and ST-1 runtime handoffs in PR #1244; the active asset, classification authority, permanent memory owners, and runtime/code/test evidence remain protected, and D6-R35-T is next.
