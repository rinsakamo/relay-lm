  ...
  -> RT-1 Retrieval projection and hard cutover             in progress
       ...
       -> RT-1D structural-seam architecture amendment      P1 Return recorded; runtime not started
          -> RT-1D-S1 reader seams                          complete in PR #789; behavior-preserving; mandatory P8 and resulting-main verification pending
             -> RT-1D-S2 worker seams                       next prerequisite only after S1 P8 merges and resulting main is verified; then mandatory P8 and verification
