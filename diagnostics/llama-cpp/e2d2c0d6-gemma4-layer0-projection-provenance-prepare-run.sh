...
out = {
    ...
    "relaylm_authority_remote_head": (root / "relaylm-authority.remote-head.txt").read_text(encoding="utf-8").strip(),
    "relaylm_authority_tree": (root / "relaylm-authority.tree.txt").read_text(encoding="utf-8").strip(),
    "relaylm_authority_origin_url": (root / "relaylm-authority.origin-url.txt").read_text(encoding="utf-8").strip(),
