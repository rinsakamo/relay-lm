...
from relaylm.soul_lab_memory_correction_routes import (
    install_primary_memory_correction_routes,
)
from relaylm.soul_lab_memory_forget_routes import install_primary_memory_forget_routes
...
def create_app(config_path: str | None = None) -> FastAPI:
    ...
    install_primary_memory_forget_routes(
        app=app,
        config=config,
        configured_loopback=configured_loopback,
    )
