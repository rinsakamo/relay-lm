...
M3D_RESULT_FIELDS = {
    ...
    "helper_only",
    "read_only",
    "runtime_private_handoffs",
    "enabled",
    "dry_run_only",
    "apply_enabled",
    "write_apply_supported",
    "apply_allowed",
    "writes_memory",
    "updates_index",
    "updates_log",
    ...
    "lab_api_exposed",
    "runtime_wired",
    "visible_response_changed",
    "store_root_configured",
    "page_candidate_valid",
    "handoff_count",
    "handoffs",
    "blocked_reasons",
    "projection",
...
M3D_PROJECTION_FIELDS = {
    ...
    "content_free",
    "content_included",
    "store_root_path_included",
    "candidate_id_included",
    "namespace_included",
    "target_path_included",
    "lineage_fingerprint_included",
    "idempotency_key_included",
    "page_markdown_included",
    "page_digest_included",
    ...
    "writer_apply_eligible_count",
    "root_present",
    "target_parent_present",
    "target_exists",
