...
class RequestDiagnostics:
    ...
    relayint_fast_path_dry_run: dict[str, Any] | None = None
    relayint_quick_clarification_preflight: dict[str, Any] | None = None
    relayint_quick_clarification_apply_plan: dict[str, Any] | None = None
