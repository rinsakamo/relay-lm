...
STATE_CLASS_DEFINITIONS = MappingProxyType(
    {
        ...
        "user.preference": (
            ...
            "confidence; epistemic contrast: tentative ('might prefer tea; not sure') means no "
            "durable State, resolved ('prefer tea to coffee') may establish durable preference, "
            "and temporary ('not in the mood for tea today; usual preference unchanged') must not "
            "remove durable preference; temporary mood or situational variation does not revoke "
            "an established durable preference; comparative preference does not by itself imply "
            "dislike of the weaker item or revoke an existing weaker-item liking; when the weaker "
            "subject already has a positive preference State, keep that State unless the current "
            "Input explicitly denies or revokes it, and represent the stronger subject and any "
            "category-level preference with separate specific keys"
        ),
