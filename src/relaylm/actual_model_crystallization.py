...
class ActualModelCrystallizationReasoningIdentity:
    """Attested reasoning state that can affect one crystallization output."""
    ...
    def __post_init__(self) -> None:
        if self.format_version != 1:
            raise ValueError(
                "unsupported actual-model crystallization reasoning format_version: "
...
class ActualModelCrystallizationManifest:
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(
            ...
            raise TypeError(
                "reasoning_identity must be ActualModelCrystallizationReasoningIdentity"
            )
    ...
    def to_mapping(self) -> dict[str, object]:
        return {
            ...
            "reasoning_identity": self.reasoning_identity.to_mapping(),
            "seed": self.seed,
