"""Transaction selector for the #2624 Continuity-only production diagnostic."""
...
HOST_MODULE = "relaylm.actual_model_stage_r_llama_cpp_production_continuity_only"
HOST_SUMMARY_FILENAME = "production-continuity-only-t2-summary.json"
