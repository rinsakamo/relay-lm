"""Transaction selector for the #2697 unresolved-only no-Pass1 diagnostic."""
...
HOST_MODULE = "relaylm.actual_model_stage_r_llama_cpp_production_unresolved_no_pass1"
HOST_SUMMARY_FILENAME = "production-unresolved-no-pass1-t2-summary.json"
